...
Valor do Investimento:
    ...
    <input type="radio" name="juros" value="0.002" checked="checked" /> Poupança
    
    <input type="radio" name="juros" value="0.003" /> Tesouro Direto

    <input type="radio" name="juros" value="0.010" /> Bolsa 
    </br>
